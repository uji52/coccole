...
function usageAndExit() {
  console.log('Usage: node tools/generate_cloudfront_signed_cookies.js --privateKey ./private_key.pem --publicKeyId APKA... --domain coccole-dev.uji52.com --ip 1.2.3.4/32 --expires 3600');
  process.exit(1);
}
